...
#Solution vector
x = LA.solve(A,b)
rnkA = LA.matrix_rank(A)
rnkAb = LA.matrix_rank(Ab)
...
#if using termux
plt.savefig('/storage/emulated/0/github/cbse-papers/2020/math/10/solutions/figs/matrix-10-9.pdf')
subprocess.run(shlex.split("termux-open /storage/emulated/0/github/school/ncert-vectors/defs/figs/cbse-10-9.pdf"))
#else
#plt.show()
