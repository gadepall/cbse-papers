...
\end{enumerate}
\solution 
		Letting the given points be $\vec{A},\vec{B}$. 
		\begin{align}
...
\solution
In general, if three vertices of a rectangle are given, the adjacent sides need to be identified first to identify the opposite vertices.  For example, in the given problem,  
  \begin{align}
